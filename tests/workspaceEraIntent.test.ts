...
describe('[codex 지시문 02 TASK J] WORKSPACE_ERA_INTENT registry', () => {
  it('has a real entry for all 10 workspaces', () => {
    const ids = Object.keys(WORKSPACE_ERA_INTENT);
    expect(ids.sort()).toEqual(
      ['jp-2030', 'jp-kids', 'jp-chillhop', 'jp-cafe-chillhop', 'kr-2030', 'kr-idol-female', 'kr-idol-male', 'kr-kids', 'senior-oldpop', 'en-chillhop'].sort()
    );
  });
