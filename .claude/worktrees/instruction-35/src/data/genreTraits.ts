...
export const GENRE_TRAIT_OVERRIDES: Record<string, GenreTraitOverride> = {
  ...
  // 지시문 35 (TASK A) — 신규 랩·멈블랩 8종. genreLibrary/index.ts의
  // rhythm/vocal/harmony/production 필드가 이미 2개 이상씩 있어 여기서는
  // dynamicRange·structureTraits(이 파일에만 있는 축)만 채운다.
  'kr2030-rap-mumble-melodic': {
    dynamicRange: 'low',
    structureTraits: ['verse rides a half-time trap groove with mumbled dragged-vowel delivery', 'pre-chorus barely lifts before a melodic autotuned hook']
  },
  'kr2030-rap-whisper-trap': {
    dynamicRange: 'low',
    structureTraits: ['verse stays close-mic and near-spoken throughout', 'chorus stays hushed instead of opening wide']
  },
  'kr2030-rap-emo-sing-rap': {
    dynamicRange: 'wide',
    structureTraits: ['verse builds from spoken-edge rap into a soaring autotuned hook', 'guitar-led bridge swells before the final hook repeat']
  },
  'kr2030-rap-laidback-alt-rnb': {
    dynamicRange: 'low',
    structureTraits: ['verse sits behind the beat with minimal lift into the hook', 'chorus stays intimate rather than opening into a belt']
  },
  'kr2030-rap-drill-dark': {
    dynamicRange: 'medium',
    structureTraits: ['verse builds tension over a sliding 808 into a hard-hitting hook', 'hi-hat pattern density rises through the pre-chorus']
  },
  'kr2030-rap-boom-bap-modern': {
    dynamicRange: 'medium',
    structureTraits: ['verse-driven lyrical flow building into a punchy hook', 'chorus adds a doubled hook vocal for lift without shouting']
  },
  'kr2030-rap-cloud-hazy': {
    dynamicRange: 'low',
    structureTraits: ['verse floats over washed reverb with minimal dynamic contrast', 'hook layers pitched vocal chops instead of raising intensity']
  },
  'kr2030-rap-female-melodic': {
    dynamicRange: 'medium',
    structureTraits: ['verse builds from a conversational flow into a sung-rap hook', 'hook stacks a doubled melodic vocal for lift']
  }
};
