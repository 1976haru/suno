...
function runPackMode(args: ReturnType<typeof parseArgs>) {
  ...
  const report = runFullAudit(blueprint.songs, { conceptLabel, songCount, audienceProfile, audioReport, vocalQuotaOverride: channel.vocalQuotaOverride, archetype: channel.archetype, lyricLanguage });
