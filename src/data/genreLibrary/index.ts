...
const legacyGenreProfiles: StructuredGenrePack[] = [
  ...
  legacyGenrePack({ id: 'smooth-jazz-lounge', label: 'Smooth Jazz Lounge', styleCore: 'smooth jazz lounge, cocktail-lounge shuffle swing, vibraphone comping, saxophone bridge solo', instruments: ['vibraphone', 'walking upright bass', 'brushed ride cymbal', 'mellow saxophone'], tempoRange: [86, 104], goodFor: ['evening lounge', 'dinner cafe', 'refined senior playlist'] }, 'jazz', { rhythm: ['cocktail-lounge shuffle swing'], vocal: ['optional mellow lounge vocal'], production: ['dim analog lounge room tone'], harmony: ['ii-V-I turnarounds'], moods: ['refined', 'relaxed'], audiences: ['evening lounge', 'dinner cafe'], avoidTraits: ['bebop-fast tempo', 'harsh saxophone tone'] })
];
