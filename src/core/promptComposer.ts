...
export function songOutputShape(generateThumbnailText: boolean, packagingLanguage: 'english' | 'korean' | 'japanese' = 'english') {
  return {
    ...
    storyPov: "'couple' | 'male' | 'female' optional; copy from preassignedSongs if present",
    cafeStoryMode: "'couple' | 'male' | 'female' optional; copy from preassignedSongs if present",
    storySourceEpisodeId: 'string optional; copy from preassignedSongs/meta if present',
    storySourceTitle: 'string optional; copy from preassignedSongs/meta if present',
    storySourceSummary: 'string optional; copy from preassignedSongs/meta if present',
    storyPreviousContext: 'string optional; copy from preassignedSongs/meta if present',
    storyNextHint: 'string optional; copy from preassignedSongs/meta if present',
    storyLocation: 'string optional; copy from preassignedSongs/meta if present',
    storySeason: 'string optional; copy from preassignedSongs/meta if present',
    cafeLocation: 'string optional; copy from preassignedSongs/meta if present',
    cafeType: 'string optional; copy from preassignedSongs/meta if present',
    cafeSeason: 'string optional; copy from preassignedSongs/meta if present',
    cafeTimeOfDay: 'string optional; copy from preassignedSongs/meta if present',
    cafeWeather: 'string optional; copy from preassignedSongs/meta if present',
    storySpeaker: "'couple' | 'male' | 'female' optional; copy from preassignedSongs if present",
    storyAct: 'number optional; copy from preassignedSongs if present',
    storyActLabel: 'string optional; copy from preassignedSongs if present',
    storyArcRole: 'string optional; copy from preassignedSongs if present',
