...
// 지시문 63 (TASK B-5) — kids의 '2' 비중을 4 -> 8로 올린다("동요 곡 안
// 다중진행 8/15 이상" 기준, 현재값 4/15). '3'은 0을 그대로 유지한다 —
// 바로 위 §하지 말 것 "동요에 3개 진행을 강제하지 말 것"은 여전히
// 유효하고(지시문63 자신의 "하지 말 것"과 충돌하지 않는다 — 지시문63은
// '2'개 진행만 요구할 뿐 '3'개를 요구하지 않는다), '1'을 11에서 7로
// 줄여 합계 15를 유지한다. 추정치(verified: false)이며, "따라 부르기
// 쉬움이 우선"이라는 원래 취지는 진행이 2개로 늘어도 절/후렴 구간 구분일
// 뿐 절 자체의 복잡도는 그대로라 유지된다.
